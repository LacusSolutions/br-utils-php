 ...
 * CnpjType. This is a business logic exception and it is highly recommended
 * that users of the library catch it and handle it appropriately.
 */
class CnpjGeneratorOptionTypeInvalidException extends CnpjGeneratorException
{
    ...
    public function __construct(string $actualInput, array $expectedValues)
    {
        ...
        parent::__construct("CNPJ generator option \"type\" accepts only the following values: \"{$expectedValuesString}\". Got \"{$actualInput}\".");
