...
/**
 * Base error for all `cnpj-val` type-related errors.
 *
 * This abstract class extends the native `TypeError` and serves as the base
 * for all type validation errors in the CNPJ validator.
 */
abstract class CnpjValidatorTypeError extends TypeError
{
